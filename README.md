...
■ 신호가 맞았나 (하루 뒤 기준)
🟢 50선 위로  1건 중 1건 맞음  평균 ▲1.4%
🔴 50선 아래로  1건  아직 하루가 안 지났습니다
...
| 칸 | 무엇을 보나 |
| --- | --- |
| **오늘 움직임** | 감시 중인 코인이 얼마나 올랐고 내렸는지, 그날 고점과 저점. 알림이 한 건도 없던 코인도 나옵니다 |
| **지금 두 선** | 지금 두 선이 몇 % 벌어져 있는지. **교차에 가까운 순서**로 위에서부터. `좁혀지는 중`이면 다음에 볼 종목입니다 |
| **신호가 맞았나** | 온 알림이 가리킨 방향으로 실제로 움직였는지. 🟢는 올랐으면, 🔴는 내렸으면 맞은 것으로 셉니다 |
| **받은 알림** | 언제 어느 코인에 무엇이 왔는지와 그 뒤 1시간·4시간·하루 변화 |
...
주간 리포트도 같은 모양이고, 기간이 월~일로 바뀌며 알림 목록에 날짜가 함께 붙습니다.
